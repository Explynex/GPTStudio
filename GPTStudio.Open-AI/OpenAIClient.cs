...
using GPTStudio.OpenAI.Completions;
using GPTStudio.OpenAI.Edits;
using GPTStudio.OpenAI.Embeddings;
using GPTStudio.OpenAI.Files;
using GPTStudio.OpenAI.FineTuning;
using GPTStudio.OpenAI.Images;
using GPTStudio.OpenAI.Models;
using GPTStudio.OpenAI.Moderations;
...
namespace GPTStudio.OpenAI
{
    ...
    public sealed class OpenAIClient
    {
        ...
        /// or <see langword="null"/> to attempt to use the <see cref="GPTStudio.OpenAI.OpenAIAuthentication.Default"/>,
